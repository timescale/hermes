...
// Type aliases for clarity in specific contexts
export type ProjectConfig = HermesConfig;
export type UserConfig = HermesConfig;
export type Config = HermesConfig;
 ...
 */
export async function readConfigValue<K extends keyof Config>(
  key: K,
